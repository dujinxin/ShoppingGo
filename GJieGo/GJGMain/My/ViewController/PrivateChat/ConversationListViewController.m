...
@interface ConversationListViewController ()<EaseConversationListViewControllerDelegate, EaseConversationListViewControllerDataSource,UISearchDisplayDelegate, UISearchBarDelegate>
...
//        }
        ...
        UserProfileEntity *profileEntity = [[ChatManager shareManager] getUserProfileEntityByUserName:conversation.conversationId];
        if (profileEntity) {
            model.title = profileEntity.nickName == nil ? profileEntity.userName : profileEntity.nickName;
            model.avatarURLPath = profileEntity.userImage;
        }
//        NSDictionary * dict = model.conversation.ext;
//        if (dict[@"nickname"]) {
//            model.title = dict[@"nickname"];
//        }else{
//            model.title = dict[@"username"];
//        }
//        model.avatarURLPath = dict[@"imageUrl"];
