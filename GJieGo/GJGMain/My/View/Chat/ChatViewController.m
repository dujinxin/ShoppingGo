...
- (void)viewDidLoad {
    ...
    self.tableView.backgroundColor = JXF1f1f1Color;
...
//    [[EaseBaseMessageCell appearance] setRecvBubbleBackgroundImage:[[UIImage imageNamed:@"chat_receiver_bg"] stretchableImageWithLeftCapWidth:35 topCapHeight:35]];
    //custom
    [[EaseBaseMessageCell appearance] setSendBubbleBackgroundImage:[[UIImage imageNamed:@"dialog_blue"] stretchableImageWithLeftCapWidth:15 topCapHeight:15]];
    [[EaseBaseMessageCell appearance] setRecvBubbleBackgroundImage:[[UIImage imageNamed:@"dialog_white"] stretchableImageWithLeftCapWidth:35 topCapHeight:15]];
...
//    }
    ...
    UserProfileEntity *profileEntity = [[ChatManager shareManager] getUserProfileEntityByNickName:model.nickname];
    NSLog(@"model.nickName = %@",model.nickname);
    if (profileEntity) {
        model.avatarURLPath = profileEntity.userImage;
        model.nickname = profileEntity.nickName;
    }
...
- (void)backAction
{
    ...
    [[ChatUtil shareHelper] setChatVC:nil];
