...
{
    self = [self initWithFrame:frame horizontalPadding:15 verticalPadding:7 inputViewMinHeight:35 inputViewMaxHeight:150 type:EMChatToolbarTypeGroup];
    if (self) {
...
{
    self = [self initWithFrame:frame horizontalPadding:15 verticalPadding:7 inputViewMinHeight:35 inputViewMaxHeight:150 type:type];
    if (self) {
